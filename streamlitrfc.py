...
st.write("Cervical Cancer Prediction")

data = pd.read_csv("risk_factors_cervical_cancer.csv")

col1, col2, col3 = st.columns(3)
age = int(col1.number_input("Enter your age:"))
num_partners = int(col2.number_input("Enter your number of sexual partners:"))
age_inter = int(col3.number_input("Enter your age of first sexual intercourse:"))
num_preg = int(col1.number_input("Enter the number of pregnancies you've had:"))
smokes = True if col2.selectbox("Do you smoke?:", ["Yes", "No"]) else False
smokes_year = int(col3.number_input("How many years have you smoked?:"))
smokes_per_year = int(col1.number_input("How many packs per year do you smoke?:"))
hormonal_contraceptives = True if col2.selectbox("Are you using hormonal contraceptives?:", ["Yes", "No"]) == "Yes" else False
hormonal_years = int(col3.number_input("How many years have you been on hormonal contraceptives?:"))
IUD = True if col1.selectbox("Do you have an IUD?:", ["Yes", "No"]) == "Yes" else False
IUD_years = int(col2.number_input("How many years have you had a IUD?:"))
STD = True if col3.selectbox("Have you ever had an STD?:", ["Yes", "No"]) == "Yes" else False
STD_num = int(col1.number_input("How many STDs have you had?:"))
...
total_std = int(col1.number_input("How many total STD diagnosis do you have?:"))
std_start = int(col2.number_input("How long in years has it been since your first diagnosis?:"))
std_last = int(col3.number_input("How long in years has it been since your last diagnosis?:"))
